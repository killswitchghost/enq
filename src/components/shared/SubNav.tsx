...
const onScroll = () => {
  ...
  links.forEach((link) => {
    const refElement = document.querySelector(link.getAttribute('href') as string) as HTMLElement;
    if (refElement) {
      if (
  ...
  return (
    <nav id="menu-center">
      <ul>
        ...
        <li><a href="#section1" onClick={(e) => handleClick(e, '#section1')}>Section 1</a></li>
        <li><a href="#section2" onClick={(e) => handleClick(e, '#section2')}>Section 2</a></li>
        <li><a href="#section3" onClick={(e) => handleClick(e, '#section3')}>Section 3</a></li>
